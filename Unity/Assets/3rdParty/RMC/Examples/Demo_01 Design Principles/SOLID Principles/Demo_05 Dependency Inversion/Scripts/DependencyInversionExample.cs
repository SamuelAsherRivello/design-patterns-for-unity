using RMC.Examples.DesignPrinciples.SOLID.DependencyInversionPrinciple.Player;
using RMC.Examples.DesignPrinciples.SOLID.DependencyInversionPrinciple.Player.Interfaces;
using RMC.Examples.DesignPrinciples.SOLID.DependencyInversionPrinciple.Settings;
using UnityEngine;

namespace RMC.Examples.DesignPrinciples.SOLID.DependencyInversionPrinciple
{
	/// <summary>
	...
	/// 
	/// </summary>
	public class DependencyInversionExample : MonoBehaviour
	{
		[SerializeField] 
